...
<body>
   ...
   <section class="checkout-orders">
      ...
      <form action="" method="POST">
         ...
         <input type="submit"  name="order" class="btn <?= ($grand_total > 1) ? '' : 'disabled'; ?>" value="Cash on delivery">
         <input type="submit" id="payment-button"  name="order" class="btn <?= ($grand_total > 1) ? '' : 'disabled'; ?>" value="Cash on delivery">
